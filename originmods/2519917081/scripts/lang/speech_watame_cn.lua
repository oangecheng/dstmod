...
return {
	ACTIONFAIL =
	{
        REPAIR =
        {
            WRONGPIECE = "應該不是這樣用的吧。",
        },
        BUILD =
        {
            MOUNTED = "わため不能把他放在這裡啊。",
            HASPET = "わため已經有一隻寵物了。",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "啊！不小心吵醒你了，但這不是わため的錯對吧？",
		...
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "鑰匙壞了啊！這...這不是わため的錯哦！",
        	KLAUS = "哇伊！是聖誕老人！你是來給わため禮物的嗎？",
			QUAGMIRE_WRONGKEY = "わため已經找到另一把鑰匙了。",
        },
		ACTIVATE = 
		{
			LOCKED_GATE = "這扇門可以通往トワ醬的家嗎？",
		},
        COOK =
        {
        ...
        GIVE =
        {
            ...
            DEAD = "疑耶耶耶！？沒...沒關係，わため會幫你保管東西的。",
            SLEEPING = "不能悄悄地放在他旁邊嗎？",
            BUSY = "需要わため的幫忙嗎？",
        ...
        WRITE =
        {
            GENERIC = "該是展現吟遊「詩人」的實力了！",
            INUSE = "你也正在構思偉大的創作嗎？",
        },
        DRAW =
        {
            NOIMAGE = "わため沒有參考圖就畫不出來呀！",
        },
        CHANGEIN =
        {
            GENERIC = "現在不是換衣服的時候。",
            BURNING = "啊啊啊！要變成成吉思汗烤肉了啦！",
            INUSE = "わため會好好等待著的。",
        },
        ATTUNE =
        {
            NOHEALTH = "わため覺得身體不太舒服...",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "上啊！牛羊一心同體！",
            INUSE = "啊！牛牛被其他人騎走了。",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "接下來就讓わため教你怎麼作戰吧！",
        },
        TEACH =
        {
            --Recipes/Teacher
	...
	ANNOUNCE_BEES = "噢，就算有羊毛擋著還是會痛啊！",
	ANNOUNCE_BOOMERANG = "去幫我撿回來，ころね前輩！",
	ANNOUNCE_CHARLIE = "疑耶！？是...是ぼたん醬嗎？",
	ANNOUNCE_CHARLIE_ATTACK = "噢嗚，不是ぼたん醬，你是誰？",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "羊毛不夠厚...好冷！",
	ANNOUNCE_HOT = "わため要被烤成成吉思汗烤肉了！",
	ANNOUNCE_CRAFTING_FAIL = "I'm missing a couple key ingredients.",
	ANNOUNCE_DEERCLOPS = "這聲音，應該不是ココ醬吧？",
	...
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "如果わため送你禮物就能讓你消氣嗎？",
        "蟻獅先生別生氣，わため帶了好東西給你。",
        "本來想給你わため珍藏的洋芋片的，但是被わため吃掉了。",
	},
	ANNOUNCE_SACREDCHEST_YES = "裡面有好吃的零食嗎？",
	ANNOUNCE_SACREDCHEST_NO = "感覺不應該這樣。",
    ANNOUNCE_DUSK = "傍晚的天空跟ココ醬的髮色一樣美。",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "嗯，真好吃！",
		PAINFUL = "わため覺得身體不太舒服...",
		SPOILED = "はあちゃま前輩做的食物比這好吃啊...",
		STALE = "趁它快壞掉之前把它吃掉吧！",
		INVALID = "這不是身為吟遊詩人該吃的東西啊！",
        YUCKY = "嘔嘔嘔，わため到底吃了什麼？",
	...
	ANNOUNCE_ENTER_DARK = "這裡好暗啊！",
	ANNOUNCE_ENTER_LIGHT = "わため又重見光明了！",
	ANNOUNCE_FREEDOM = "自由了！わため終於自由啦！",
	ANNOUNCE_HIGHRESEARCH = "わため現在學識更淵博了！",
	ANNOUNCE_HOUNDS = "狼來了！狼來了！誰快來救救わため啊！",
	ANNOUNCE_WORMS = "地面在震動？",
	ANNOUNCE_HUNGRY = "好想吃洋芋片...",
	ANNOUNCE_HUNT_BEAST_NEARBY = "感覺是從未見過的生物，他在哪裡呢。",
	ANNOUNCE_HUNT_LOST_TRAIL = "啊，追丟腳印了。",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "嗯...或許わため不小心嚇跑他了？",
	ANNOUNCE_INV_FULL = "わため需要更大的背包才能裝下它。",
	ANNOUNCE_KNOCKEDOUT = "わため...不能控制自己了！",
	ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
	ANNOUNCE_MOSQUITOS = "Aaah! Bug off!",
    ANNOUNCE_NOWARDROBEONFIRE = "衣櫃燒起來了，快點滅火呀！",
	...
	ANNOUNCE_DAMP = "噢，真是涼爽。",
	ANNOUNCE_WET = "わため的羊毛濕漉漉的。",
	ANNOUNCE_WETTER = "わため的羊毛可以擰出一攤水來了。",
	ANNOUNCE_SOAKED = "わため快被大雨淹沒了。",

	ANNOUNCE_WASHED_ASHORE = "就算わため淹死了，也只要8秒就能復活！",

    ANNOUNCE_DESPAWN = "わため要休息了，有機會再一起玩吧！",
    ...
    --hallowed nights
    ANNOUNCE_SPOOKED = "那是什麼！？不要靠近わため啊！",
	ANNOUNCE_BRAVERY_POTION = "わ...わため不會害怕的！",
