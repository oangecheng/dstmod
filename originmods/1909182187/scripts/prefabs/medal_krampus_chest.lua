...
local function onopen(inst)
	...
	if inst.components.inventoryitem then
		inst.components.inventoryitem:ChangeImageName("medal_krampus_chest_item2")
	end
end
...
local function onclose(inst)
	...
	if inst.components.inventoryitem then
		inst.components.inventoryitem:ChangeImageName("medal_krampus_chest_item1")
	end
end
...
local function itemfn()
	...
	inst.components.inventoryitem.imagename = "medal_krampus_chest_item1"
