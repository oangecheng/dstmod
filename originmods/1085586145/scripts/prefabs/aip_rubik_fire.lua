...
local aipScale=3
local aipSmokeScale=1

local aipTimeScale=1.2
local aipSmokeTimeScale=1
local aipSmokeOffset=0
...
1,
lifetime,
px,py+.35+aipSmokeOffset,pz,
vx,vy,vz,
math.random()*360,--*2*PI,
UnitRand()*2,
0,0
)
end
...
local hand_num_particles_to_emit=-1
