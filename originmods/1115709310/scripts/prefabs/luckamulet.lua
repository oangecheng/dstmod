...
local function onequip(inst, owner) 
    if not inst or not owner then return end
...
local function onunequip(inst, owner) 
    ...
    inst:RemoveEventCallback("locomote", inst.onwalk)
    inst:RemoveEventCallback("picksomething", inst.get4)
    inst:RemoveEventCallback("working", inst.get3)
    inst:RemoveEventCallback("oneat", inst.get3)
    inst:RemoveEventCallback("fishingstrain", inst.get1)
    inst:RemoveEventCallback("refreshcrafting", inst.get2)
    inst:RemoveEventCallback("attacked", inst.get3)
end
