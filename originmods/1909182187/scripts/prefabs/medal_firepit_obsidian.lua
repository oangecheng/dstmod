...
local function MakeMedalFirepit(name,iscold)
	...
	local function fn()
		...
		if iscold then
			inst.components.burnable:AddBurnFX("medal_obsidiancoldfirefire", Vector3(0, .15, 0), nil, true)
		else
			inst.components.burnable:AddBurnFX("medal_obsidianfirefire", Vector3(0, .65, 0), nil, true)
		end
...
return MakeMedalFirepit("medal_firepit_obsidian",false),
	...
	MakePlacer("medal_firepit_obsidian_placer", "firepit", "medal_firepit_obsidian", "preview"),
	MakePlacer("medal_coldfirepit_obsidian_placer", "firepit", "medal_coldfirepit_obsidian", "preview")
