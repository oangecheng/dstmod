...
local function CtrlNightVision(inst)
	if inst._nightvision:value() then
...
local common_postinit = function(inst)
	...
	inst:AddTag("fastbuilder")			--快速制作
	inst:AddTag("valkyrie")				--武神头、矛
	inst._nightvision = net_bool(inst.GUID,"carney.nightvision","carneynightvisiondirty")
	inst:ListenForEvent("carneynightvisiondirty", CtrlNightVision)		--夜视
end
...
local master_postinit = function(inst)
	...
	inst:ListenForEvent("CtrlNightVision", CtrlNightVision)		--夜视
