...
local function updatefuelrate(inst)
    inst.components.fueled.rate = TheWorld.state.israining and deluxeFirepitBurnRate + TUNING.FIREPIT_RAIN_RATE * TheWorld.state.precipitationrate or deluxeFirepitBurnRate
end
