...
local states =
{
    ...
    State{
        ...
        onupdate = function(inst)
            ...
            elseif inst.sg.statemem.queen:IsValid() and
                inst:IsNear(inst.sg.statemem.queen, TUNING_MEDAL.MEDAL_BEEGUARD_GUARD_RANGE) then
                inst.Physics:SetMotorVel(2, 0, 0)
            else
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.sg.mem.dash = inst.components.locomotor.walkspeed > TUNING_MEDAL.MEDAL_BEEGUARD_SPEED
