...
return {
	...
	ANNOUNCE_HOUNDS = "The wolfs are here again. Help me!",
	ANNOUNCE_WORMS = "Isn't the ground shaking?",
	ANNOUNCE_HUNGRY = "I wanna eat potato chips.",
